<?php
	...
	$query = "INSERT INTO tblvehicle (make, model, Type, Odometer, Licensenumber, available, cost, availablefrom, availableto, imgname)
				VALUES('$make', '$model', '$ctype', '$odometer', '$licenseplate', '$available', '$cost', '$availablefrom', '$availableto','$imagepath')";
